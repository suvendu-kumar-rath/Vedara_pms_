          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b bg-muted/40">
                {["Project Name", "Client", "Location", "Designer", "Status", "Action"].map((h) => <th key={h} className="text-left px-5 py-3 font-medium text-muted-foreground">{h}</th>)}
              </tr>
            </thead>
            <tbody>
              {projectList.map((p) => <tr key={p.id} className="border-b last:border-0 transition-colors hover:bg-muted/30">
